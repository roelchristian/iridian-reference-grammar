...
Vowel length is phonemic in Iridian. Length is represented by an acute accent\index{acute accent} over the long vowel (or in the case of \bt{\o}, over the first vowel in the digraph). The short-long vowel pairs differ in quality as well as length, with the short vowels being more and the long vowels being tenser in addition to being longer.
