...
\pex
\ird{Zd\'u\v{s}ek.}\\
(instead of \ird{*zdu\v{s}ek} from zdu\v{s}\'a + -a\v{s}-)\\
\trsl{(I) took a shower.}
\xe
\pex
\ird{Pia\v{s}\v{c}ek.}\\
...
\pex
\begingl
\gla N\'au ri\v{s}tn\'al.//
\glb clothes wear-\mk{pv-cont}//
...
\pex
\begingl
\gla N\'au ri\v{s}tnal\'i.//
\glb clothes wear-\mk{pv-prog}//
...
\par The subjunctive mood (glossed \mk{sbj}) is used for actions or events that are not or are not known to be true or factual. The subjunctive has two forms: the perfective subjunctive in \ird{-\'il} and the imperfective subjunctive in \textbf{-ú}, glossed as \mk{sbj.pf} and \mk{sbj.ipf} respectively.
...
\begin{table}[h!]
	...
	\begin{tabularx}{0.7\textwidth}{YMM}
		...
		&{\sc non-neg}&{\sc neg}\\
		\midrule
		Imperfective&niec &po\v{s}c\\ \addlinespace
		Perfective& vace & nav\\
		\bottomrule
	\end{tabularx}
\end{table}
\par The perfective-imperfective distinction of the subjunctive is more properly analyzed as a temporal distinction, i.e., past and non-past subjunctive. Table \ref{pia\v{s}ta} shows the conjugation paradigm of the verb \ird{pia\v{s}tá} in the subjunctive mood.
\begin{table}[h!]
	...
	\begin{tabu} to 0.7\textwidth{Y>{\bfseries}Y}
		\toprule
		\multicolumn{2}{c}{\ird{pia\v{s}tá} `to eat'}\\
		\midrule \addlinespace
		 Imperfective& pia\v{s}tú\\ \addlinespace
		 Negative imperfective & zápia\v{s}tú\\ \addlinespace
		 Perfective & pia\v{s}t\'il\\ \addlinespace
		 Negative perfective & z\'apia\v{s}t\'il\\ \addlinespace
		 \bottomrule
	\label{pia\v{s}ta}		 
	\end{tabu}
\end{table}
...
\pex
\begingl
\gla Martin na America \v{z}nohú to \v{c}ezn\'alic.//
\glb Martin \mk{loc} America-\mk{pat} study-\mk{sbj.ipf} \mk{rz} want-\mk{cont-3s.anim}//
...
\a
\begingl
\gla P\'a\v{s}ta Janom vo\v{s}tnek.//
