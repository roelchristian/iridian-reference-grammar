...
sentence like \ird{Tóm na měza} while being interpreted as {The book is on the
table} without any additional context, can also be understood as \trsl{The books
are on the table} if it is clear to both the speaker and the listener that the
