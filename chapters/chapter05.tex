...
\glb because traffic-\Agt{} on:time-\Ins{} \mk{neg}-arrive-\mk{av-pf-1s}//
...
\begin{itemize}
    ...
    \glb Marek-\Pat{} \mk{exst} friend-\Gen{} many//
    ...
    \glb for class-\Pat{} \mk{1pl.inc.wk} \mk{exst} many watch-\mk{sup} \mk{att} film.//
...
\glb this see-\mk{pv-pf-quot} yes see-\Pv{}-\Pf{} yes//
