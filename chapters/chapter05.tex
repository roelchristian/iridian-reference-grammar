...
For numbers 11 to 19, the words are formed by appending the numbers from one to nine to the suffix \textit{-niem} with the preposition \textit{še} (with).
...
\par Table \ref{3099} shows multiples of 10 from 30 to 100. The numbers are formed by the numeral followed by \ird{tydná}. For bases that are not multiples of 20, the word \ird{nau} \trsl{ten} is added first, followed by the conjunction \ird{še} \trsl{with}.
...
\begin{table}[h!]
	...
	\begin{tabu}to 0.9 \textwidth {M[0.5]YM[0.5]Y}
		...
		50 &	naušemuitydná	& 90	& naušedrohutydná\\
