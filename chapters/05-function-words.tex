...
\begin{table}[ht]
	...
	\begin{tabularx}{\textwidth}{l L L l}
		...
		Class 2 &
		\ird{by}, \ird{och}, \ird{moc}, \ird{či}, \ird{kamo}/\ird{kam}, \ird{dlí}, \ird{jse} &
		propositional and illocutionary meanings such as interrogation, addition, affirmation, hearsay stance, exclusivity, temporary priority, and contrast &
		middle \\
		Class 3 &
...
contribute propositional and illocutionary meanings such as interrogation,
addition, affirmation, hearsay stance, exclusivity, temporary priority, and
contrast. Their ordinary position is between any Class~3 particle and any
Class~1 particle.

\paragraph{By} \ird{By} is the yes-no question particle. It marks the clause as
a polar question and ordinarily has scope over the proposition as a whole,
though the informational focus of the question may fall on a particular
constituent in context. Its place in the Class~2 series shows that polar
questioning belongs to the propositional layer rather than to the event-internal
phasal layer occupied by \ird{v} and \ird{s}.

\pex
\a
\begingl
\gla Marek by zdravime?//
\glb Marek.\Dir{} question sleep-\Prog{}//
\glft \trsl{Is Marek sleeping?}//
\endgl
\a
\begingl
\gla Janek by v piašček?//
\glb Janek.\Dir{} question already eat-\Antip{}-\Pf{}//
\glft \trsl{Has Janek already eaten?}//
\endgl
\xe

In ordinary conversation, intonation alone may sometimes suffice for yes-no
questions, but \ird{by} is the overt particle strategy and is especially
natural in careful, explicit, or formally written style. Where \ird{v} and
\ird{s} specify whether the question concerns an attained result, an ongoing
state, or an open interval, \ird{by} contributes the interrogative force
itself.
...
When \ird{jse} combines with the yes-no particle \ird{by}, the result is often
