...
\begin{table}[h!]
	...
	\begin{tabu} to 0.5\textwidth{YY[0.5]}
		...
		Progressive		& \ird{-ime} \\
		Contemplative	& \ird{-\'ach/-\'ah}\\
		Prospective		& \ird{-ujam}\\
		Cessative		& \ird{-óvít}\\
		\bottomrule
	\end{tabu}
...
\medskip
    ...
    \begin{tabu}to \textwidth{Y[0.7]Y[0.6]YY}
         \toprule\addlinespace
		 										& {\cscaps causative } &{\cscaps regular meaning} & {\cscaps causative meaning}\\\addlinespace
...
\sffamily\footnotesize
    ...
    \begin{tabu}to 0.7\textwidth{YYY}
         ...
         &{\cscaps imperative}&{\cscaps prohibitive}  \\
         \midrule
...
\small
	...
	\begin{tabu} to \textwidth {Y[0.9]Y[0.7]Y}
		...
		\midrule
			...
			\multicolumn{3}{l}{{\cscaps subjunctive}}\\
				\quad Imperfective &
				...
				\ird{piaščóvít} $\rightarrow$ \ird{piaščóvíce}\\
			\multicolumn{3}{l}{{\cscaps imperative, \&c.}}\\
				\quad Imperative &
				...
				\ird{piaščóvít} $\rightarrow$ \ird{piaščóvíce}\\
			\multicolumn{3}{l}{{\cscaps other forms}}\\
