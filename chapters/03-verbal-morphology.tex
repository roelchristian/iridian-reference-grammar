...
also does not grammaticalise \foreign{aktionsart}, and thus the distinction
...
mood}\label{sec:imp-hort}\index{imperative}\index{hortative}
...
nominalizing suffix \ird{-ou} (glossed as \Nz{}). Linguists generally recognise
...
\pex    \irdp{zuštalá}{to be happy} → \irdp{zuštalouc}{happiness}\\
...
\section{Stative verbs}\index{verbal adjective|see{stative verb}}\index{stative
verb}\index{adjectives}\label{sec:statives}
