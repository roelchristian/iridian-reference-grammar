...
{\sc grammatical mood} is a grammatical category that expresses the attitude of the speaker or writer with respect to the proposition expressed by the verb. In Iridian, there are four grammatical moods: indicative\index{indicative mood}, imperative\index{imperative mood}, hortative\index{hortative mood},
...
The conditional mood is used in statements which are not true or verifiably true, or whose truth is unknown or is dependent on another condition. The use of the conditional mood include wishes, judgments, or opinions, among others. This form is also called the `conjunctive' in other grammars, after the name in Iridian (\ird{konjunktivné htě}) which itself borrows from the German \foreign{Konjunktiv}. There are two forms of the conditional, the imperfective and the perfective, distinguished by whether or not the purported action has been completed. These are formed by the suffixes \ird{-y} and \ird{-il} respectively. Table \ref{tbl:conditional} shows the forms of the conditional mood.
