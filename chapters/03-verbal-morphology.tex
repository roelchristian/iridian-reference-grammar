...
\begin{figure}
	...
	\bigskip
	\begin{tabu} to \textwidth{@{}YYY[0.8]YY[0.8]YY[0.8]Y[1.2]@{}}
		...
		\multicolumn{8}{@{}l}{\irdp{zápiašček}{(I) did not eat.}}\\ \addlinespace
		zá- &
		$\emptyset$ &
		-piašt- &
		-aš- &
		...
		& & & & & & & \\ \addlinespace % empty line
		\multicolumn{8}{@{}l}{\irdp{zánepiaštébice}{(He) was said to not have fed.}}\\ \addlinespace
		...
		& & & & & & & \\ \addlinespace % empty line
		\multicolumn{8}{@{}l}{\irdp{zánepiaštébalnile}{If he were said to not have been able to feed.}}\\ \addlinespace
...
\pex
	\begingl
		...
		\glb Marek sing-\Av{}-\Cond{}.\Ipf{}-\Quot{} \Rz{} Janek say-\Av{}-\Pf{}.//
...
\begin{table}
    ...
    \medskip
    \label{tbl:modality}
    \begin{tabu}to 0.5\textwidth{@{}Y[1.4]Y@{}}
			\toprule \addlinespace
...
gerunds}\index{gerund}\index{nominalization}\label{nom-morph}
...
\glb Jan-\Gen{} \Ger{}-stand.up-\mk{cont-nz} annoying//
...
\ird{iec} (glossed \Cv{}.\Ipf{}) and the perfective
\ird{-u} (glossed \Cv{}.\Pf{}).
