...
country's southeast counties (\ird{prest}), near the border with Hungary, speak
...
The English name Iridia is from the Latinized form of the medieval endonym
    \ird{Irdzaume} (cf. the modern \ird{Ircóme}) meaning ``Land of the Irdz
    ...
    \foreign{Iridie}, Portuguese \foreign{Irídia} or Korean \foreign{Illijiya}.
    Most Central and Eastern European languages use an exonym closer to the
    Iridian endonym: see, for example, German \foreign{Irtzland}, Czech Jírice
    or Polish \foreign{Ircja}.} The origin of the word \ird{Irdz} is uncertain,
...
Iridia as a nation state howver has been a relatively new development. The
...
as the Iridian Republic (\ird{Ircevní respublika}), has since been a member of
...
\section{The Iridian people and its neighbors}\index{sec:iridians}

\ird{Ircóme} is the name of the country in the Iridian language, \ird{irc} the
name of the people, and \ird{ircevní malno} the name of the language. Iridia is
...
The Iridian language (\ird{ircevní malno}) is a language isolate belonging to
...
classifies words into four main classes: \irdp{kaděc}{nouns},
\irdp{hloutěc}{verbs}, \irdp{priděc}{modifiers}, and
\irdp{zvuk}{function words}. We will follow this system for much of this book,
