...
\begin{table}[ht]
	...
	\begin{tabularx}{\textwidth}{l L L l}
		...
		Polar embedding: whether-questions, embedded yes/no content &
		§\,\ref{sec:poby} \\[4pt]
...
phenomena that would otherwise require separate stipulations. The ban on
in-situ wh-phrases in polar questions without overt \ird{by} follows from
the licensing principle in §\,\ref{sec:th-multiple-wh}: interrogative
variables must be within the scope of the clause-level interrogative operator.
...
The scope separation between \ird{by} and the comment-domain operators
(§\,\ref{sec:by-kamo}) follows from their distinct projections. And the
