...
(SS) pattern, but the broader generalization is one of \term{same-pivot} or
...
signaled by overt lexical NPs, demonstratives, or the discourse structure
itself; Iridian has no grammaticalized switch-reference clitic. Where both
...
supported by discourse context; Iridian has no grammaticalized switch-reference
