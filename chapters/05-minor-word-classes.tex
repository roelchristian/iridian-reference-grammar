...
\begin{itemize}[nosep]
	...
	\item Class 3: \ird{iz}, \ird{oče}, \ird{nadě} and \ird{děne}
\end{itemize}
...
The use of \ird{iz} requires two conditions: (1) the utterance must be directly
...
\ird{iz} inferential in nature instead of merely expressing some doubt or
...
\ird{Iz} cannot appear in questions, instead replaced by \ird{děne}
