...
eat}. The conjunctive ending \ird{-má} can also be used in
(\ref{ex:contrastive-part-2}) resulting to the more forceful \irdp{Dá grazy pro
piaščevěmá}{But I do eat vegetables}; however, \ird{pro} alone should be
...
the following sentences which both contain the phrase \irdp{za Marka}{for (the
...
sentence, however, \ird{za Marka} is used as a modifier, and thus cannot be
...
\label{sec:prepositions}\index{prepositions}
