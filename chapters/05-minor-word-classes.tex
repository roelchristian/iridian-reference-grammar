...
\begin{itemize}[nosep]
	...
	\item Class 2: \ird{li}, \ird{može}, \ird{što}, \ird{kamo}, \ird{samo}, \ird{jate} and \ird{prev}
	\item Class 3: \ird{dvé}, \ird{oče}, \ird{nadě} and \ird{delí}
\end{itemize}
...
\begingl
	...
	\glb Marek arrive-\Av{}-\Pf{} with Janek že eat-\Av{}-\Ret{}//
	\glft \trsl{Janek had already eaten when Marek arrived.}//
\endgl
\a
\begingl
	\gla Marek ščenžách še Janek že piaščaní.//
	\glb Marek arrive-\Av{}-\Ctp{} with Janek že eat-\Av{}-\Ret{}//
...
\begingl
	...
	\glb into store-\Acc{} yesterday što po go-\Av{}-\Pf{}//
...
\begingl
	...
	\glb who Marek-\Gen{} house-\Ins{} po arrive-\Av{}-\Pf{}?//
...
\begingl
	...
	\glb Janek može \Neg{}-arrive-\Av{}-\Pf{}//
...
\begingl
	...
	\glb \Second{}.\Sg{} može že see-\Pv{}-\Pf{}//
...
\begingl
	...
	\glb Janek što already arrive-\Av{}-\Pf{}//
...
\begingl
	...
	\glb Janek oče može po \Refl{}-sleep-\Av{}-\Cont{}//
...
particle \ird{oče}. The order of particles in Iridian is strict and thus sentences like the following are not grammatical:
