...
\paragraph{\irdU{mo\v{z}e}} This particle corresponds to the English \trsl{also/too} or \trsl{neither} and is used to express agreement to a prior statement, or as a conjunctive particle with the meaning of \trsl{in addition.} This particle must appear immediately after the phrase it modifies, unless it modifies the whole sentence, in which case it must appear before the verb. When followed by the particle \ird{by}, i.e. \ird{mo\v{z}e by}, it is used to contradict a negative assertion.
...
\pex
\a \ird{na dum\'i veha}, \trsl{in front of the house}
\a \ird{na bamen\'i pouda}, \trsl{behind the building}
\xe
...
\a \irdp{cam drohutýdna}{nine and four twenties} i.e., 89
...
and \irdp{ně hrona les}{about three times} but \ird{měs a měs ko cel}{hundreds
of people}.
