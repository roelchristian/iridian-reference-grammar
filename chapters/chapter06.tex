...
\begin{multicols}{2}
  ...
  \glb farmer Pit\'ar//
  \glft \trsl{Pit\'ar is \textbf{the} farmer.}//
  \endgl
  \xe
\end{multicols}
...
after the word being negated by \ird{z\'am} (i.e., if the negative clitic is not
