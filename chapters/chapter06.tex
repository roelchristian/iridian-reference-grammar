...
\glb Viktor \Loc{} siblings-\mk{pat} \mk{comp=rz=} to:be:tall-\mk{av-pf}//
...
\glb university \Loc{} city-\mk{pat} to:be:big-\mk{comp-nz}//
\glft \trsl{(This) university is the biggest in the city.}//
\endgl
\a
\begingl
\gla Univerzitet na razmeka ohnu pizdenou.//
\glb university \Loc{} city-\mk{pat} first-\mk{inst} to:be:big-\mk{comp-nz}//
\glft \trsl{(This) university is the biggest in the city.}//
\endgl
\xe
...
\begingl
\gla Dá na duma.//
\glb \mk{1s.str} \Loc{} house-\mk{pat}//
...
\begingl
\gla Na duma niho dá.//
\glb \Loc{} house-\mk{pat} \mk{exst.neg} \mk{1s.str}//
...
\glb Martin-\mk{pat} \mk{exst} write-\mk{pv-pf-nz} \Loc{} wall-\mk{pat}//
