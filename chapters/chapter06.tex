...
\subsection{Content questions}\index{\emph{wh-}question}\index{information question|see{\emph{wh}-question}}\index{content question|see{\emph{wh}-question}}
...
Alternatively, the element being questioned may be replaced with a question word without changing the original word order. The addition of the clitic \ird{no} is required in this case. Note that questions formed this way generally have a more emphatic meaning.
...
%% TODO add section on pied-piping
\emph{Wh}-fronting may sometimes elements of (\cite[263-4]{ross1967})

In cases where there are multiple \emph{wh}-elements in the sentences, they are normally all fronted, with the main question word first followed by the rest in order of importance.

\pex
\begingl
\gla Jede je\v{z}e hloup\v{s}kou?//
\glb who what ask-\Av{}-\Pf{}-\Nz{}//
\glft \trsl{Who asked what?}//
\endgl
\xe
