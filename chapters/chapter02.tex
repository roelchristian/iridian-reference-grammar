...
\glb yesterday \Loc{} school-\mk{pat} Marek see-\mk{pv-pf}//
...
\glb three year-\mk{inst} \Loc{} Budapest-\mk{pat} live-\mk{av-ret-1s}//
...
\glb \mk{1s.str} \Loc{} Prague-\mk{pat} live-\mk{cont}//
...
\glb vase Janek-\Gen{} \mk{caus-}break-\mk{pv-pf}//
...
\glb \mk{dem} \Loc{} church-\mk{pat} parents \mk{rec}-wed-\mk{av-pf}//
...
\glb \mk{pl=} senator \mk{rec}-shout-\mk{av-prog} \mk{rz} \Loc{} television-\mk{pat} see-\mk{av-pf}//
...
\section{Grammatical Mood}\index{mood}
...
\glb Martin \Loc{} America-\mk{pat} study-\mk{av-sbj} \mk{rz} want-\mk{av-cont-3s.anim}//
...
\glb water 100 Celcius-\Ins{} \mk{caus}-heat-\mk{ben-cond.rl} \mk{ref-}boil-\mk{av-cont}//
...
\glb name \Loc{} list-\mk{pat} \mk{cop.cond.rl} dean-\mk{gen} office-\mk{pat} go-\mk{av-hort}//
...
\glb \mk{1s} this book-\mk{gen} read-\mk{av-sup}//
