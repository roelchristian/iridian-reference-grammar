...
In Iridian, the suffix \ird{-ou} is most productive in producing CENs. SENs, on the other hand, require the use of the prefix \ird{po-}, and are more properly analysed as {\sc gerunds}\index{gerund} while RNs are generally formed using other morphological strategies (see \S~\ref{sec:nomder-verb}), although some verbs may allow a resultant nominal to be formed from the uninflected verb root and the suffix \ird{-ou} (e.g., \irdp{pia\v{s}tou}{food} from \irdp{pia\v{s}t\'a}{to eat}).
...
\pex \a Nominalised forms of \irdp{pia\v{s}tou}{to eat} showing a productive morphological RN:\smallskip\\
		\vtop{\halign{%
			...
			\quad SEN/Gerund:		& \irdp{popia\v{s}tou}{the act of eating}\cr
			\quad CEN:				& \irdp{pia\v{s}\v{c}kou}{(his) having eaten}\cr
		}}
\a Nominalised forms of \irdp{vad\'a}{to think} showing a defective morphological RN and the alternative lexical RN:\smallskip\\
	\vtop{\halign{%
		#\hfil& \qquad #\hfil\cr
			...
			\quad SEN/Gerund:		& \irdp{povadou}{the act of thinking}\cr
			\quad CEN:				& \irdp{vadnikou}{(its) being thought}\cr
}}\xe
...
The syntax of CENs is discussed in further detail in \S~\ref{sec:cen}.
