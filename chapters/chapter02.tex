...
s\section{Expressing Modality}\index{modality}\label{sec:modality}
...
Periphrastic constructions are formed using existential \ird{je\v{s}} clauses (cf. \S~XX)

\section{Potential modality}
