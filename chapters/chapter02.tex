...
Causatives may either be lexical or morphological. Lexical causatives involve the encoding of the causation on the verb itself leading the causative form of the verb to be a different form altogether. The suppletive nature of lexical causatives \cite{velupillai2012}

\pex
\a Joseph \emph{died}.
\a Joseph \emph{killed} the man
\a Joseph \emph{made} the man die.
\xe
