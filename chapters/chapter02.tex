...
\pex
\begingl
\gla To švirek moc gruševí še o\v{s}tinévnílá.//
...
\begin{multicols}{2}
  ...
  \a
  \begingl
  \gla T\'om zo\v{s}tin\'a\v{s}.//
  \glb book \mk{neg-}read-\mk{pv-sup}//
  \glft \trsl{(We) don't need to read the book.}//
  \endgl
  \a \begingl
  \gla T\'om o\v{s}tni\v{s}kev\'i.//
...
\pex
\begingl
\gla Tereza kravniec nóv\'i palžek. //
\glb Tereza cry-\mk{cv.ipf} room-\mk{gen} leave-\mk{av-pf}//
...
\pex
\begingl
\gla Nóv\'i palzu Tereza neikravnašek.//
\glb room-\mk{gen} leave-\mk{cv.pf} Tereza \mk{incho}-cry-\mk{pf}//
...
\glb Anna Karenina for school-\mk{pat} read-\mk{pv-sup} book//
\glft `I have to read \textit{Anna Karenina} for school.'//
\endgl

\a\begingl
\gla T\'om behlenik to oštnice.//
\glb book buy-\mk{pv-pf} \mk{rz} read-\mk{pv-sup}//
...
\glb now homeland-\mk{gen} leave-\mk{lv-sup} time//
...
\glb already noon time have:breakfast-\mk{lv-sup}//
