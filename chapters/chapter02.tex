...
\glb coffee-\Pat{} \mk{ref}-drink-\mk{av-ctplv-1s}//
...
\begingl
\gla Pulša uvošček.//
\glb soup-\Pat{} \mk{ref-}cook\mk{-av-pf}//
...
\glb three year-\Ins{} \Loc{} Budapest-\Pat{} live-\mk{av-ret-1s}//
...
\glb daily-\Ins{} \mk{ill} school-\Pat{} go-\mk{av-cont}//
...
\glb \mk{1s.str} \Loc{} Prague-\Pat{} live-\mk{cont}//
...
\glb vase Janek-\Gen{} \mk{caus-}break-\Pv{}-\Pf{}//
\glft \trsl{(I) made John break the vase.}//
\endgl
\a
\begingl
\gla Váz Janka nenopriznek.//
\glb vase Janek-\Pat{} \mk{caus-}break-\Pv{}-\Pf{}//
\glft \trsl{(I) made John break the vase.}//
\endgl
\xe
...
\begingl
	...
	\glb Martin deer-\Pat{} drive-\mk{cv} die-\Av{}-\Pf{}//
	\glft \trsl{Martin ran over a deer.} (He did it on purpose)//
\endgl
\a
\begingl
	\gla Martin nésta najevec shražaní.//
	\glb Martin deer-\Pat{} drive-\mk{cv} die-\mk{av-ret}//
...
\glb Karel-\Ins{} \mk{rec}-talk-\mk{av-prog-1s} with Marek arrive-\Av{}-\Pf{}//
...
\glb \mk{dem} \Loc{} church-\Pat{} parents \mk{rec}-wed-\Av{}-\Pf{}//
...
\glb \mk{pl=} senator \mk{rec}-shout-\mk{av-prog} \mk{rz} \Loc{} television-\Pat{} see-\Av{}-\Pf{}//
...
\glb Mišek \Com{} Martin-\Ins{} \mk{rec}-know-\mk{av-prog}//
...
\glb \mk{2s.str} Mišek-\Ins{} \mk{rec}-know-\mk{av-ret} \mk{q}//
...
\glb \mk{ref} see-\mk{pv-subj.ipf} {lest} leave-\Av{}-\Pf{}//
...
\glb Martin \Loc{} America-\Pat{} study-\mk{av-sbj} \mk{rz} want-\mk{av-cont-3s.anim}//
...
\glb name \Loc{} list-\Pat{} \mk{cop.cond.rl} dean-\Gen{} office-\Pat{} go-\mk{av-hort}//
...
\glb Jan-\Gen{} pasta-\Gen{} \mk{ger-}cook-\mk{nz}//
...
\glb Anna Karenina for school-\Pat{} read-\mk{pv-sup} book//
\glft `I have to read \textit{Anna Karenina} for school.'//
\endgl

\a\begingl
\gla Tóm behlenik to oštnit.//
\glb book buy-\Pv{}-\Pf{} \mk{rz} read-\mk{pv-sup}//
...
\glb \mk{1s} this book-\Gen{} read-\mk{av-sup}//
...
\glb be:angry-\Pv{}-\Pf{} \mk{att} god soon \mk{ref-}avenge-\mk{av-ctpv} //
