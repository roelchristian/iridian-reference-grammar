    ...
    \begin{tabu}to \textwidth{Y[0.5]Y[0.6]YY}
         \toprule\addlinespace
				...
				unmarked				& neshradá									& to die, to be dead 	& \emph{(defective)} \\ \addlinespace
		 		Agentive				& \ird{neshrážá}			& to kill & to cause someone to kill\\ \addlinespace
...
The attributive form is derived by replacing the infinitive marker \ird{-á} with \ird{-í}. Other than its conjugated comparative form ending in \ird{-ení}, the attributive
...
The nominal form is derived by replacing the infinitive marker \ird{-á} with the nominalizing suffix \ird{-ou}.
