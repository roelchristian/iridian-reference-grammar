...
\begingl
    ...
    \glb \mk{hon=} brother\mk{-dim=q} arrive-\mk{av-pf} //
...
There are four basic declension classes (or simply declensions) in Iridian, distinguished from one another by the final letter of the stem. Most Iridian words end with the stem final vowels -a, -e, -o, -\'o or -i, or with a consonantal stem.
...
\begin{table}[h]
    ...
    \midrule\addlinespace
        Agentive    & -\'am   & -em     & -am    & -\'ovam  & -\'inam    & -\'am\\ \addlinespace
        Patientive  & -e      & -\'ina  & -ie    & -\'ova   & -\'ina     & -a\\ \addlinespace
        Genitive    & -\'i    & -en\'i  & -en\'i & -\'ov\'i & -en\'i     & -\'i\\ \addlinespace
        Instrumental& -u      & -emu    & -u     & -\'ovie  & -imu       & -u\\ \addlinespace
...
\begin{table}[h!]
	...
	\begin{tabu} to 0.9 \textwidth {Y[3]YYYY}
		...
		\midrule\addlinespace
        \emph{Strong form}  & d\'a      & j\'a      & m\'e      & tov\'a \\\addlinespace
        \emph{Weak form}    &           &           &           & \\\addlinespace
        \quad Agentive      & d\'am     & j\'am     & m\'am     & t\'am\\\addlinespace
        \quad Patientive    & do        & j\'i      & mnie      & te\\\addlinespace
        \quad Genitive      & \v{z}e    & jen\'i    & mnev\'i   & tev\'i\\\addlinespace
        \quad Instrumental  & du        & jemu      & mo        & tve\\\addlinespace
        \emph{Clitic form}  & -em       & -e\v{s}   & -ic       & -ak\\\addlinespace
        \bottomrule
	\end{tabu}
...
\pex    \a \irdp{Udu\v{s}ek}{I took a bath.}
        \a \irdp{Se udu\v{s}ek}{I bathed myself.}
\xe

\pex
        \a \irdp{Gul\'a\v{s}e upia\v{s}\v{c}ek}{I ate some goulash.}
        \a \ljudge{?} \irdp{Se upia\v{s}\v{c}ek}{I ate myself.}
\xe
...
\a\deftaglabel{obv1}
\begingl
\gla Dá je svou je dnu zaprev\'i.//
...
\ex
\begingl
\gla *Dá je svou je svou zaprev\'i.//
