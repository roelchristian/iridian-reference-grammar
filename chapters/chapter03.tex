...
The first declension contains nouns ending in \ird{-a} \ird{-o} and \ird{-\'a}.

\begin{table}
    \small
    \caption{The first declension}
    \medskip
    \begin{tabu} to \textwidth {YY[0.8]YY}
    \toprule
    & {\irdp{cigra}{tiger}} & {\irdp{malno}{language}} & {\irdp{kom\'a}{boat}} \\
    \midrule
    Unmarked    & cigr-a    & maln-o     & kom-a\\
    Agentive    & cigr-am   & maln-am    & kom-\'am\\
    Patientive  & cigr-e    & maln-e     & kom-ie\\
    Genitive    & cigr-\'i  & maln-\'i   & kom-\'i\\
    Ablative    & cigr-em   & maln-em    & kom-im\\
    Instrumental& cigr-u    & maln-u     & kom-ou\\
    Vocative    & cigr-u    & maln-u     & kom-ou\\
    \bottomrule
    \end{tabu}
\end{table}
...
\begin{table}
    \small
    \caption{The second declension}
    \medskip
    \begin{tabu} to 0.8\textwidth {YYY}
    \toprule
    & {\irdp{metr\'o}{metro}} & {\irdp{pia\v{s}tou}{food}} \\
    \midrule
    Unmarked    & metr-\'o    & pia\v{s}t-ou\\
    Agentive    & metr-\'ovam     &  pia\v{s}t-\'ovam\\
    Patientive    & metr-\'ova     &  pia\v{s}t-\'ova\\
    Genitive    & metr-\'ov\'i     &  pia\v{s}t-\'ov\'i\\
    Ablative    & metr-\'ovem     &  pia\v{s}t-\'ovem\\
    Instrumental    & metr-\'oju     &  pia\v{s}t-\'oju\\
    Vocative    & metr-\'oja     &  pia\v{s}t-\'oja\\
    \bottomrule
    \end{tabu}
\end{table}
...
\begin{table}
    \small
    \caption{The third declension}
    \medskip
    \begin{tabu} to 0.8\textwidth {YYY}
    \toprule
    & {\irdp{k\'ave}{coffee}} & {\irdp{matei}{wheel}} \\
    \midrule
    Unmarked    & k\'av-e    & mat-ei\\
    Agentive    & k\'av-in\'am    & mat-\'n\'am\\
    Patientive  & k\'av-e\v{s}    & mat-i\v{s}\\
    Genitive    & k\'av-en\'i    & mat-\'en\'i\\
    Ablative    & k\'av-am   & mat-iam\\
    Instrumental    & k\'av-emu     &  mat-iemu\\
    Vocative    & k\'av-emu     &  mat-iemu\\
    \bottomrule
    \end{tabu}
\end{table}
