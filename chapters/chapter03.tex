...
\a
\begingl
\gla Je svou je dnu zapr\'al.//
\glft \trsl{(He) is as tall as either this person or that person.}//
\endgl
\xe
...
Interestingly, the obviation system in Iridian is only two-way, with the medial and the distal merged into the latter.
