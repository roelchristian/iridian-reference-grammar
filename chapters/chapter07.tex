...
When coordinating simple noun pairs, however, the particle \irdp{\v{s}e}{with}\index{\v{s}e} is mostly used where English would have used "and". The derived construction \ird{a \v{s}e} is also common and has a similar meaning to the English \trsl{and also}.
...
In a few cases, \ird{a} is used instead of \v{s}e where the latter can be interpreted as having an attributive meaning.
...
Where the noun is marked, only \ird{a} can be used.
\pex
\begingl
