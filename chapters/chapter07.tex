...
\begingl
    ...
    \glb Janek and \Com{} Marek-\Ins{} class fail-\mk{av-pf-quot}//
...
\begingl
    ...
    \glb Ivan Jarek Elena \Loc{} room-\mk{pat}//
...
\glb go-\mk{av-pf} but \Loc{} house-\mk{pat} \mk{nexst} person//
...
\glb be:young-\mk{cv.ipf} when \Loc{} Warsaw-\mk{pat} understand-\mk{av-ret}//
...
\glb father \Loc{} war-\mk{pat} die-\mk{pv-pf-quot} with console-\mk{pv-hort}//
