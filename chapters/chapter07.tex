...
\begingl
    ...
    \glb this class-\mk{foc} Janek-\Agt{} and Marek-\Agt{} class fail-\mk{pv-pf-quot}//
...
\begingl
    ...
    \glb and suffering-\mk{} and \Com{} happiness-\Ins{} remain-\mk{cv} love-\mk{av-ctpv}//
...
\a\begingl
    ...
    \glb interesting-\mk{att} and engineering study\mk{-pv-sbj.ipf} \mk{rz} choose-\Pv{}-\Pf{}//
...
\a\begingl
    ...
    \glb good-\mk{att} and \mk{2s.str} arrive-\Av{}-\Pf{}//
...
\glb for exam-\Pat{} \mk{neg}-study-\mk{cv.pf} Martin fail-\Av{}-\Pf{}//
...
\glb on:time-\Ins{} \mk{neg}-arrive-\mk{cv.pf} because forgive-\mk{pv-hort}//
...
\glb father \Loc{} war-\Pat{} die-\mk{pv-pf-quot} with console-\mk{pv-hort}//
...
\glb no \mk{qp} whisper-\mk{cv} say-\Av{}-\Pf{}//
...
\begingl
  ...
  \glb and Janek have:breakfast-\mk{av-pf-quot} whether ask-\Av{}-\Pf{}//
...
\begingl
  ...
  \glb and book this year-\Ins{} finish-\mk{pv-ctpv-quot} whether \mk{pl} fan be:excited-\mk{cont}//
