...
\pex
\begingl
    \gla \textbf{a} hastu \textbf{a} \v{s}e zmenu zoviec hloubi\v{z}\'ach.//
...
\pex
\begingl
    \gla Morkve, hlepost, ruk, molec hladni\v{z}ev\'i.//
    \glb carrot asparagus broccoli cabbage to:notplease-\mk{av-cont}//
    \glft \trsl{I don't like carrots, asparagus, broccoli or cabbage.}//
\endgl
\xe

\ird{A} or \ird{\v{s}e} however is required when two adjectives are used to modify a noun, with \ird{\v{s}e} used when the two adjectives describe the same noun and \ird{a} (or often \ird{a \v{s}e}) when describing two distinct objects.\footnote{When used this way, the noun preceding \ird{\v{s}e} or \ird{a \v{s}e} is not declined in the instrumental case.}

\pex
\a
\begingl
    \gla Sodov\'i \textbf{\v{s}e} lud\'i kobera tahatnik.//
    \glb black with white shirt bring-\mk{pv-pf}//
    \glft \trsl{I brought the black-and-white shirt.}//
\endgl
\a
\begingl
    \gla Sodov\'i \textbf{a} \textbf{(\v{s}e)} lud\'i kobera tahatnik.//
...
\pex
\a\begingl
    \gla Interezn\'i a t\'eknik znohou\v{s}tnil\'a te pr\'adelnik.//
...
\pex
\a\begingl
    \gla Shlac a prov\'isor \v{s}\v{c}en\v{z}ek, kurs \v{s}el\v{c}in\'ach.//
...
\ird{M\'a} and \ird{ozn\'a} are used to express contrast, like the English \trsl{but}. \ird{Ozn\'a} however is more restrictive, and can only be used if the first clause is in the negative and the second clause directly contradicts (or provides an alternative to) the first.

\pex
\begingl
\gla Sto\v{z}ek m\'a na duma niho \v{c}ast.//
