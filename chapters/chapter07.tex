...
\glb \mk{neg} cat to:please-\mk{av-cont} but dog//
...
\a\begingl\deftagex{appos}\deftaglabel{res}
    \gla \'Oto \textbf{ko} mlažka na Mnihe znohouševí.//
...
\glb for exam-\mk{pat} \mk{neg}-study-\mk{cv.pf} Martin fail-\mk{av-pf}//
...
\glb cinema-\mk{pat} go-\mk{av-sbj.ipf} \mk{rz} be:angry-\mk{cv.ipf} mother-\mk{dim} allow-\mk{av-pf}//
...
\glb grandmother-\mk{dim-pat} see-\mk{cv.pf} children run-\mk{cv.ipf} go:out-\mk{av-pf}//
...
\glb exam-\mk{pat} pass-\mk{cv.pf} because praise-\mk{pv-hort}//
