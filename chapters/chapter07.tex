...
the contrastive \ird{m\'a} and \ird{ozn\'a} (both translate to English\index{English} as \trsl{but}); and
...
\pex\a\begingl\deftagex{ni}
\gla D\'a ircevn\'i malnov\'im ni zahviržétev\'i.//
...
\glft \trsl{I can't speak neither Iridian nor Russian.}//
\endgl
\a\deftaglabel{resp}\vtop{\halign{%
#\hfil& \qquad #\hfil\cr
