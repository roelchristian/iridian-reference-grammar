...
\begin{table}[h!]
  ...
  \ird{ploc}    & \ird{plu\v{s}ka } & family\\\addlinespace
  \ird{hor}    & \ird{horka}       & parents\\\addlinespace
  \ird{maty}    & \ird{m\'amka}     & mother\\\addlinespace
  \ird{t\'aty}  & \ird{p\'apka}     & father\\\addlinespace
  \ird{hre\v{s}t}    & \ird{hri\v{s}tka}     & sibling\\\addlinespace
  \ird{mlaz}    & \ird{mla\v{z}ka}     & brother\\\addlinespace
  \ird{vod}    & \ird{vodka}     & sister\\\addlinespace
  \ird{proud}    & \ird{prudka}     & oldest sibling/child\\\addlinespace
  \ird{zneibo}    & \ird{zn\'ibka}     & youngest sibling/child\\\addlinespace
  \ird{roho\v{s}}    & \ird{ru{z}ka}     & son\\\addlinespace
  \ird{jaja}    & \ird{j\'ajka}     & daughter\\\addlinespace
  \ird{vremou}    & \ird{vrem\'ovka}     & child\\\addlinespace
