...
Iridian punctuation\index{punctuation} is consistent with the punctuation rules of most European languages.
...
\begin{enumerate}
	\item A full stop/period (.) is used:
		\begin{enumerate}
			...
			\item to separate the components in a date when abbreviating (e.g., 23.\thinspace01.\thinspace2009 vs English 23/01/2009) — a half-space is used after the period in this case;
