...
This section describes verbal negation --- the use of \ird{zá-} with finite predicates --- exclusively. Negation in equative clauses (zero-copula constructions) and existential clauses (the \ird{jec-}/\ird{zad-} alternation) is treated in §\,\ref{sec:clausal-negation} of Chapter~\ref{ch:simple}; the theoretical analysis of all three negation strategies as reflexes of a single NegP projection is developed in §\,\ref{sec:vm-neg} and §\,\ref{sec:vm-neg-exponents} of the verbal morphosyntax companion (\texttt{util/stub/verb-minim.tex}).
