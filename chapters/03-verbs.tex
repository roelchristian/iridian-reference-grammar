...
paradigmatic organization at \synhead{MoodP}, not of compositional negation.
...
Participant nominals may serve as the predicative complement of a zero-copula equative clause, with the topic \synhead{DP} identified as the entity satisfying the nominalized description. This construction has the schematic form:
...
(\synhead{AspP}, \synhead{IP}, \synhead{TopP}) are realized by progressively more leftward
...
is to formalize exactly which feature of \synhead{AspP} triggers which
...
\synhead{NegP}, \synhead{MoodP}, and the inner evidential) are realized as suffixes on the verbal
