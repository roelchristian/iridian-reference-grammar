...
syntactically understood but ordinarily unexpressed; no pronominal clitic is
required. The theme or patient of the clause occupies the direct case as the
...
An evidential suffix occupies the slot between Mood and the person clitic. This
...
precedes the complement linker \ird{-e} and follows any person clitic. Wait ---
actually the order documented in \S\,\ref{sec:compl-indirect-evid} is:
...
\noindent This places the evidential \emph{outside} Mood but \emph{inside}
person clitics. The corresponding syntactic projection is therefore above MoodP
but below AgrP (person). The boundary with the clausal EvidP$_\text{outer}$ (a
...
verbal complex; the outer EvidP particles (Zone~I) operate at the clause-level
and take scope over the full proposition including its discourse-relational
frame.
