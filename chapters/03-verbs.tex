...
dimensional properties such as \ird{svor} \trsl{bigness} --- whilst others
...
distinguished: \textbf{canonical quality statives}, which denote evaluative
properties of things (\trsl{be good}, \trsl{be beautiful}, \trsl{be bad});
\textbf{dimensional statives}, which denote extent or scale properties
(\trsl{be big}); and \textbf{experiential and bodily-condition statives}, which
