...
\draw[->] (0.5,0) -- (8.5,0);
\draw[evt] (3.2,0) -- (5.0,0);
\draw (3.2,0.18) -- (3.2,-0.18);
\draw (5.0,0.18) -- (5.0,-0.18);
\draw[decorate,decoration={brace,mirror,amplitude=4pt}] (3.2,-0.35) -- (5.0,-0.35)
  node[midway,yshift=-0.38cm] {$R$};
\node at (4.1,0.35) {$E$};
\node[speech] (s1) at (4.1,-0.95) {};
\node[below=2pt of s1] {$S$};
\draw[dashed] (4.1,-0.78) -- (4.1,-0.08);

% retrospective
\node[rowlab] at (0,-1.6) {retrospective};
\draw[->] (0.5,-1.6) -- (8.5,-1.6);
\draw[evt] (2.2,-1.6) -- (3.8,-1.6);
\draw (2.2,-1.42) -- (2.2,-1.78);
\draw (3.8,-1.42) -- (3.8,-1.78);
\node at (3.0,-1.25) {$E$};
\node[refpt,label=above:$R$] (r2) at (6.1,-1.6) {};
\node[speech] (s2) at (6.1,-2.55) {};
\node[below=2pt of s2] {$S$};
\draw[dashed] (6.1,-2.38) -- (6.1,-1.78);

% continuous
\node[rowlab] at (0,-3.2) {continuous};
\draw[->] (0.5,-3.2) -- (8.5,-3.2);
\draw[dotted] (1.8,-3.2) -- (2.4,-3.2);
\draw[evt] (2.4,-3.2) -- (6.3,-3.2);
\draw[dotted] (6.3,-3.2) -- (6.9,-3.2);
\node at (4.4,-2.85) {$E$};
\node[refpt,label=above:$R$] (r3) at (4.4,-3.2) {};
\node[speech] (s3) at (4.4,-4.15) {};
\node[below=2pt of s3] {$S$};
\draw[dashed] (4.4,-3.98) -- (4.4,-3.38);

% progressive
\node[rowlab] at (0,-4.8) {progressive};
\draw[->] (0.5,-4.8) -- (8.5,-4.8);
\draw[evt] (2.6,-4.8) -- (6.5,-4.8);
\draw (2.6,-4.62) -- (2.6,-4.98);
\draw (6.5,-4.62) -- (6.5,-4.98);
\draw[->] (3.8,-4.45) -- (5.0,-4.45);
\node at (4.55,-4.1) {dynamic phase};
\node[refpt,label=above:$R$] (r4) at (4.2,-4.8) {};
\node at (5.9,-4.45) {$E$};
\node[speech] (s4) at (4.2,-5.75) {};
\node[below=2pt of s4] {$S$};
\draw[dashed] (4.2,-5.58) -- (4.2,-4.98);

% contemplative
\node[rowlab] at (0,-6.4) {contemplative};
\draw[->] (0.5,-6.4) -- (8.5,-6.4);
\node[refpt,label=above:$R$] (r5) at (3.3,-6.4) {};
\node[speech] (s5) at (3.3,-7.35) {};
\node[below=2pt of s5] {$S$};
\draw[dashed] (3.3,-7.18) -- (3.3,-6.58);
\draw[evt] (5.0,-6.4) -- (6.7,-6.4);
\draw (5.0,-6.22) -- (5.0,-6.58);
\draw (6.7,-6.22) -- (6.7,-6.58);
\node at (5.85,-6.05) {$E$};

\node[anchor=west,align=left,font=\footnotesize] at (0.6,-8.15)
  {Dashed connectors mark the unmarked deictic baseline in which $R$ coincides with $S$.\\
   In discourse, adverbials or sequencing may shift $R$ independently of $S$.};

\end{tikzpicture}
\caption{Reichenbachian schematic for Iridian aspect. Here $E$ = event time,
$R$ = reference time, and $S$ = speech time. In the perfective, $R$ is shown as
coextensive with the bounded event; elsewhere it is shown as a point-like
vantage.}
