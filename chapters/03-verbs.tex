...
\a
\begingl
\gla Praže na stožaní.//
\glb Prague.\Dir{} \textsc{all} go-\Ret{}//
\glft \trsl{(I) have (been to) Prague before.}//
\endgl
\a Compare:
\begingl
\gla Bych Praže na stožek.//
\glb yesterday Prague.\Dir{} \textsc{all} go-\Pf{}//
...
Only the perfective and continuous are used productively in these participant nominals. In this formation \ird{-ek + -ou} contracts to \ird{-ikou}, while \ird{-eví + -ou} contracts to \ird{-ívou}: thus \ird{piaščikou} \trsl{the one who ate}, \ird{piaščivou} \trsl{the one who is eating}, \ird{piaštnikou} \trsl{that which is eaten}, and \ird{piaštébikou} \trsl{the one who was fed}. Their syntax, definiteness properties, and argument structure are treated in Section~\ref{sec:event-nominals} of Chapter~\ref{ch:nouns}.
...
% ============================================================
% STATUS: STUB — to be developed
% Iridian has a class of stative verbs that differ from active verbs in:
%   - They strongly prefer the continuous or contemplative aspect
%   - In the continuous, they read as pure states rather than habits
%   - They can function as attributive modifiers of nouns (adjectival use)
%   - The progressive aspect with a stative verb reads as "coming to be in
%     the state" (inceptive), not as an ongoing dynamic activity
% Examples:
%   - vytam shoda (I am wearing a shirt — stative continuous)
%   - vytam shodime (I am putting on a shirt — progressive = inceptive)
% The adjectival use of stative verbs is relevant to NP structure (Ch. 4)
% and is the primary device for attributive modification in Iridian
% (there is no separate adjective class in the traditional sense).
% ============================================================

A class of stative verbs describes states rather than events. These verbs differ from active verbs in their aspect profile: they occur most naturally in the continuous or contemplative, and the progressive aspect with a stative verb yields an inceptive reading --- \textit{coming to be in the state} --- rather than a dynamic activity in progress.
...
Stative verbs may further function as attributive modifiers of nouns, serving as the primary attributive strategy in Iridian. This use is described in Chapter~\ref{ch:nouns}.
