...
\midrule
Indicative   & $\varnothing$      & ---\quad (NegP projected; \ird{zá-}) \\
...
\item[\upshape A-movement to Spec,TopP.] The absolutive DP moves
  ...
  languages, but in Iridian the moved DP is the absolutive pivot
...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{l l l L}
    ...
    & \textsc{MoodP} & \ird{-ím, -é, -ká, -ku, -ěv, -ir}, $\varnothing$
