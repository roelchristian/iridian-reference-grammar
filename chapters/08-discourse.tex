...
simultaneously a choice of event shape and a choice of which participant to track
as topic. The preverbal particle system of Chapter~\ref{ch:function-words} has a
clause-peripheral counterpart in the utterance-final particles described here.
And many of the spoken morphemes discussed in the final section are formally
unremarkable from the perspective of Iridian morphology: what marks them as
colloquial is their origin and register, not their integration into the
grammatical system.
...
as the clause's discourse centre. By contrast, anchoring on transitive or
...
clausal analysis: the unmarked discourse centre is the absolutive/direct pivot,
...
morphemes whose behaviour is especially revealing for the interaction of lexical
...
The nominal behaviour of the item becomes still clearer when it combines with the
...
preceding clause or \synhead{NP}. It is not embedded inside the \synhead{NP} it elaborates; it is
