...
\begin{enumerate}
	...
	\irdp{p\v{e}r}{roof} & \irdp{p\v{e}ru}{roof (inst.)} not \ird{\sx{*}pru} \cr
	}}
	...
	\ird{hen}{crumb}  & \ird{hnu}{crumb (inst.)} \cr
	}}
...
Compensatory vowel lengthening is a process whereby a short vowel is lengthened to compensate for the loss of a long vowel in a neighbouring syllable. Compensatory vowel lengthening occurs in the following contexts:
