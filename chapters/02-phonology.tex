...
\irdp{pšehui}{annoying} [ˈpɕɛxuɪ̯ʔ] and \irdp{Oi}{Hey!} [ʔɔɪ̯ʔ].
...
[iː] (e.g., \irdp{neite}{word} /ˈneɪ̯tɛ/ but realised as [ˈneːtɛ] or ['ɲiːtɛ]).
...
to Czech\index{Czech} influence. Note that [ɾʑ] or [ʑ] is not affected by
...
(viz., \irdp{cigra}{tiger} is realised as [ˈt͡ɕɪɣɾɐ] and not [ˈt͡sɪɣɾɐ]). The
...
\irdp{Vranca}{France} [vɾɐ̃w̃t͡sɐ] vs. \irdp{Feizbuk}{Facebook} [feːzbʊx]).
...
(\ird{m\v{e}rkní}) while unvoiced consonants are called clear (\ird{hezkní}).
...
\pex
\a\phon{nazka}{ˈnäskɐ}{powder (acc.)} \a\phon{nikda}{ˈɲɪgdɐ}{fever}
\a\phon{zkáte}{sk\"aːte}{patient} \a\phon{sl\v{e}ň}{sʎɛɲ}{soup}
\xe
...
default but become soft when followed by the vowels \orth{i} or \orth{í}. The
...
\par The use of \ird{-y} is a remnant of word final short \rec{i} from Old
Iridian that has since disappeared. The same process has caused the shortening
of long \rec{i} to /ɪ/. This sound change did not distinguish between
palatalizing and non-palatalizing \rec{i} so that \rec{seni} `tooth' and
\rec{seny} `blanket' both merged to modern Iridian \ird{seny} /sɛɲ/.

\par Softening involves palatal articulation of labial consonants (e.g.,
...
\ird{a, b, c, č, d, e, f, g, h, i, j, k, l, m, n, ň, o, p, q, r, s, š, t, u, v,
w, x, y, z, ž}.
...
Iridian uses two diacritics: the caron (◌̌) and the acute accent (◌́).

The caron is used to indicate palatalization of a consonant or, in the context
of \orth{ě}, of the preceding consonant. When the letter \orth{ě} is used after
the consonants \orth{c}, \orth{n}, \orth{s} and \orth{z}, the caron is used only
with \orth{ě} and although they are effectively palatalized, the preceding
consonants are not marked. Thus one writes \orth{ně} instead of {\sx{*}ňe} or
{\sx{*}ňě}.

The accute accent is used with vowels and the letter \orth{y} to indicate a long
vowel.
