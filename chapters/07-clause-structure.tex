...
\glft \trsl{Five districts voted against the
proposal.}//
\endgl
\a
\begingl
...
vote:against-\Av{}-\Pf{}-\Nz{} \mk{rz} district five// \glft \trsl{Five is the
...
separated from the main clause by \ird{cy}.

\pex
  \begingl
    \gla „Dá záščenžit” cy zíček.//
...
\pex
  \begingl
    \gla Se to obru na večera záščenžitejí cy Marek (dá) žiček. //
...
\a Cliticized \ird{no}:\\
  ...
  \endgl
\a Cliticized \ird{no} triggering topicalization of questioned element:\\
  \begingl
...
leť}{isn't it the truth} (cf. Russian\index{Russian} \textit{\cyrtext не
