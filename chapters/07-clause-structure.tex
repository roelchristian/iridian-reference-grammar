...
example, an adjective like \trsl{big} will appear before the noun it modifies,
as in \trsl{the big box}; but a relative clause like \trsl{which we found in the
attic} will appear after the noun it modifies, as in \trsl{the box which we
found in the attic}. In Iridian, however, both forms obligatorily appear before
the noun.
