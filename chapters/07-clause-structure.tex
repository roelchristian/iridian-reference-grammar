...
also be used to express disjunction The endings \ird{-na} and \ird{-nak} can be
translated as \trsl{instead (of)} or \trsl{rather than}. Although both have the
same meaning, the latter would often carry an implication that the proposition
in the main clause is preferable to or more desirable than the proposition in
the secondary clause. Finally, the ending \ird{-nahy} can be translated as
\trsl{neither} (which is marked in both the main and the secondary clause).
