...
relative pronoun (such as "who," "that," "which," "whose," or "where"), such as
...
noun phrase that they modify. They can be restrictive or nonrestrictive.
Restrictive relative clauses are necessary to identify the specific noun or noun
phrase that is being referred to, while nonrestrictive relative clauses provide
additional, non-essential information about the noun or noun phrase, which could
be removed from a sentence altogether without changing its meaning.
...
relative clause must be linked to its antecedent with the particle ty. The
relative clause must always appear before the noun or noun phrase it modifies.

To maša magazinu vednik. ‘I saw this man at the store.’
Magazinu vednikou ty maša ‘The man I saw at the store’
*Maša ty magazinu vednikou `*whom I saw at the store man’
...
\pex
    \a \ird{nidá}\,→\,\ird{ponidou}\\
        \trsl{(my) standing up}
    \a \ird{nidá}\,→\,\ird{poniděvou}\\
