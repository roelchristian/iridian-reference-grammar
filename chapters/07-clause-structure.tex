...
topicless by default, and those that are topicless by virtue of topic ellipsis. 
...
\section{Syntax of event and participant nominals}\index{nominalisation!event
...
nominalisation\index{nominalisation}: (1)~the mainly non-productive usage of the
...
Since gerunds\index{gerund} represent the nominalisation of the
...
\ird{Jancě podohletou} which can be interpreted to mean either \trsl{the act of
...
A common type of compound verb construction involves the main verb preceded by
the imperfective converbial form of a secondary verb. The secondary verb
normally specifies the manner or the means by which the action descrubed by the
main verb is performed.
...
\ird{\v{c}e}, or less commonly \ird{dže}.}
...
where \ird{no} to the topic position and the nominalisation of the resulting
...
questions}\index{wh-question@\emph{wh-}question}\index{information
...
also means the nominalisation\index{nominalisation} of the main verb phrase,
...
elswehere. This elision does not occur where \ird{z\'am} appears elswehere in
the sentence.
...
\ird{Z\'am} attaches directly to the word or phrase it negates, although it is
