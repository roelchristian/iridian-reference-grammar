...
Counterfactuality is expressed by adding the adverbial particle to the protasis.
The use of \ird{mlada} however is only compatible with \ird{-my} or \ird{-zmy}.
...
\irdp{-kuzmy}{as long as} and \ird{-kazy}{even if}. Some examples are given
below.

\pex
\a
\begingl
  \gla Marek mlada stožilekazy, opera zaby závednil.//
  \glb Marek \Hyp{} go-\Av{}-\Cond{}.\Pf{}-\Cnj{}-even.if opera \Neg{}-see-\Pv{}-\Cond{}.\Pf{}//
  \glft \trsl{Even if Marek came, we wouldn't have been able to go to the opera together anyway.}//
\endgl
\a
\begingl
