...
\ird{by}. Both can be omitted without making the sentence grammatically
...
theirs. Generally \ird{by} is kept when the speaker is quoting themself, to
...
conjunctive ending \ird{-má} as discussed in \S\,\ref{sec:conj-contrast} as a
...
amplified by the use of the reportative particle \ird{kamo}, which implies a
...
statement, \ird{kamo} makes it clear that the statement did not come from the
speaker and that the use of the quotative is not a hedging strategy. As such,
\ird{kamo} is not used if the use of the bare quotative is for reasons of
politeness. \ird{Kamo} is particularly common in newscasts or in other formal
...
earlier in the conversation and is thus known to everyone. \ird{Kamo} is often
