...
\begin{table}[h!]
	...
	\begin{tabu} to \textwidth{Y[2]MMMM}
		...
		Non-Sib. Aff. &				& \textipa{(\jn{\|[tT}~\jn{\|[dD})}	& \textipa{(\jn{cç}~\jn{\jjg J})}  & \textipa{(\jn{kx}~\jn{gG})} \\ \addlinespace
...
\begin{table}[ht!]
	...
	\begin{tabu} to \textwidth{MM[0.1]MMM[0.1]MM}
		...
		\textit{\textbf{c} series}&& \textbf{c} \textipa{[\jn{ts}]}& \textbf{dz} \textipa{[\jn{dz}]}&&\textbf{cy, ci} \textipa{[tC]}&\textbf{dzy, -i} \textipa{[d\textctz]}\\ \addlinespace
		\textit{\textbf{\v{c}} series}&& \textbf{cs} \textipa{[\jn{tS}]}& \textbf{dc} \textipa{[\jn{dZ}]}&&\textbf{csy, -i} \textipa{[\jn{tC}]}&\textbf{dcy, -i} \textipa{[\jn{d\textctz}]}\\ \addlinespace
