...
\ifluatex
  ...
  \setmainfont{Cardo}[Scale=0.96]
  \setsansfont{Linux Biolinum O}
  \newfontfamily\CardoSmallCaps
  [Ligatures={NoRequired, NoCommon, NoContextual},
  Letters={UppercaseSmallCaps,SmallCaps},Scale=1.03]
  {Cardo}
\else
...
\titleformat{\section}
{}{\thesection}{1em}{\CardoSmallCaps\lowercase}
\titlespacing*{\section}
{0pt}{3ex plus 1ex minus .2ex}{4pt}

%% Formatting of subsections
\titleformat{\subsection}[hang]
{\sffamily\footnotesize}{\thesubsection}{1em}{\sffamily\footnotesize}
