...
\ifluatex
  \usepackage{fontspec}
  \defaultfontfeatures{Ligatures=TeX}% ,Scale=MatchLowercase} bug in current Biolinum
...
\lingset{everygla=\it\small,everyglb=\footnotesize,everyglft=\small,aboveexskip=5pt,aboveglftskip=0pt,belowexskip=5pt}
...
\titleformat{\section}
{\bfseries}{\thesection}{1em}{\bfseries}
\titlespacing*{\section}
...
\fancyhead[RE]{{{\itshape{\leftmark}}}\quad{\thepage}}
\fancyhead[LO]{{\thepage}\quad{\itshape{\rightmark}}}
\cfoot{}
