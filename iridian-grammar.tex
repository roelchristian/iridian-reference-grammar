...
\titleformat{\section}
{\sffamily}{\thesection}{1em}{\large\sffamily}
\titlespacing*{\section}
{0pt}{3ex plus 1ex minus .2ex}{4pt}

%% Formatting of subsections
\titleformat{\subsection}[hang]
{\sffamily}{\thesubsection}{1em}{\sffamily}
...
\fancyhead[RE]{{{\scshape\MakeLowercase{\leftmark}}}\hfill{\thepage}}
\fancyhead[LO]{{\thepage}\hfill{\scshape\MakeLowercase{\rightmark}}}
\cfoot{}
