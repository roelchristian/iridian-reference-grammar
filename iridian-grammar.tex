...
\def\@makechapterhead#1{%
	...
	{\parindent \z@ \centering \reset@font
		{\Large \scshape\sffamily  \thechapter}
		\par
		\vspace*{1\p@}%
		\interlinepenalty\@M
		...
		\begin{tabular}{@{\qquad}c@{\qquad}}
			...
			\\
			{\LARGE \scshape\sffamily  \MakeLowercase{#1}\par\nobreak} \\
			\\
...
\def\@makeschapterhead#1{%
	\vspace*{\p@}%
	{\parindent \z@ \centering \reset@font
		{\Large \scshape\sffamily  \vphantom{\thechapter}}
		\par\nobreak
		\vspace*{15\p@}%
		\interlinepenalty\@M
		\setlength{\arrayrulewidth}{2pt}
...
\titleformat{\section}
{\sffamily}{\thesection}{1em}{\large\scshape\sffamily\lowercase}
\titlespacing*{\section}
{0pt}{3ex plus 1ex minus .2ex}{4pt}

%% Formatting of subsections
\titleformat{\subsection}[hang]
{\small\sffamily}{\thesubsection}{1em}{\normalfont\scshape\sffamily\lowercase}
...
\fancyhf{}
\fancyhead[RE]{{{\scshape\sffamily\small\MakeLowercase{\leftmark}}}\hfill{\small\sffamily\thepage}}
\fancyhead[LO]{{\small\sffamily\thepage}\hfill{\scshape\sffamily\small\MakeLowercase{\rightmark}}}
\cfoot{}
