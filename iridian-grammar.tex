...
\titleformat{\section}
{}{\thesection}{1em}{\scshape\large\lowercase}
\titlespacing*{\section}
{0pt}{3ex plus 1ex minus .2ex}{4pt}

%% Formatting of subsections
\titleformat{\subsection}[hang]
{}{\thesubsection}{1em}{\scshape\small\lowercase}
...
\fancyhf{}
\fancyhead[RE]{{{\scshape\footnotesize\MakeLowercase{\leftmark}}}\hfill{\footnotesize\thepage}}
\fancyhead[LO]{{\footnotesize\thepage}\hfill{\scshape\footnotesize\MakeLowercase{\rightmark}}}
\cfoot{}
